...
internal static class ReportEnhancementVerification
{
    ...
    internal static void Run()
    {
        ...
        var report = EnhancedReportService.BuildSnapshot(
            ...
            [1d, 3d],
            [2d, 4d]);
        Check(report.CoreWatchVersion == "6.1.1" && report.Assessment == "확인 필요", "report executive assessment");
        ...
        try
        {
            ...
            Check(File.ReadAllText(json).Contains("\"CoreWatchVersion\": \"6.1.1\"", StringComparison.Ordinal), "report JSON export");
