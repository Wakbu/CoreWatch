...
- publish 후 해당 `CoreWatch.exe`의 시작·응답·시작 시 외부 통신 여부를 확인합니다.
...
- 로드맵 완료 릴리스: `6.1.0`
- 실행 경로: `artifacts/publish/CoreWatch-v6.1.0-win-x64/CoreWatch.exe`
- 설치 없는 ZIP: `artifacts/CoreWatch-v6.1.0-win-x64.zip`
- 설치 프로그램: `artifacts/CoreWatch-v6.1.0-Setup.exe`
