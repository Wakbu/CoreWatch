...
public partial class TelemetryMainWindow
{
    ...
    private void InitializeFeatureTreeNavigation()
    {
        ...
        AddFeatureTree(navigation, _optimizationNav, [("전원 설정", () => ScrollToText(_optimizationPage, "전원")), ("백그라운드 부하", () => ScrollToText(_optimizationPage, "백그라운드")), ("메모리 분석", () => ScrollToText(_optimizationPage, "메모리 상세")), ("저장장치 상태", () => ScrollToText(_optimizationPage, "저장장치 상태")), ("시작 프로그램", () => ScrollToText(_optimizationPage, "시작 프로그램 관리")), ("공간 정리", () => ScrollToText(_optimizationPage, "저장 공간 정리"))]);
        AddFeatureTree(navigation, ReportNav, [("내보내기", () => ScrollToText(ReportPage, "REPORT EXPORT")), ("보고서 데이터", () => ScrollToText(ReportPage, "REPORT DATASET")), ("SMART 상태", () => ScrollToText(ReportPage, "SMART / STORAGE")), ("벤치마크 이력", () => ScrollToText(ReportPage, "SQLITE BENCHMARK"))]);
